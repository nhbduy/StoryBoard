    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int arg0) {
            ...
            String[] ActionDat = new String[]{
                    "Lamine Guèye ou Lamine Coura Gueye, né le 20 septembre 1891 à Médine, mort le 10 juin 1968 à Dakar, était un homme politique sénégalais, chef du Parti sénégalais d'action socialiste."
